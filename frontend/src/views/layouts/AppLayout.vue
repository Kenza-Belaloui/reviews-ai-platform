...
<template>
  <div class="min-h-screen text-slate-100">
    ...
    <div class="fixed inset-0 -z-10 opacity-40"
         style="background-image: radial-gradient(circle at 20% 10%, rgba(99,102,241,.35), transparent 40%),
      ...
      <div class="grid grid-cols-12 gap-4">
        ...
        <aside class="col-span-12 lg:col-span-3 glass glow rounded-2xl p-4">
          <div class="flex items-center justify-between">
            ...
            <button class="px-3 py-2 rounded-xl border border-slate-700/60 hover:bg-white/5" @click="toggleTheme()">🌓</button>
          </div>
